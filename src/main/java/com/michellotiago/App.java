package com.michellotiago;

import com.michellotiago.repository.cliente.dao.ClienteDAOImpl;
import com.michellotiago.repository.cliente.dto.Cliente;
import com.michellotiago.repository.pedido.dao.PedidoDAOImpl;
import com.michellotiago.repository.pedido.dto.Pedido;
import com.michellotiago.repository.produto.dao.ProdutoDAOImpl;
...
import com.michellotiago.service.Patterns.FactoryMethod.IDatabase;
import com.michellotiago.service.Patterns.FactoryMethod.DatabaseFactory;
import com.michellotiago.service.Patterns.FactoryMethod.PostgreSQLFactory;
...
public class App {
    ...
    ClienteDAOImpl clientes = new ClienteDAOImpl();
    PedidoDAOImpl pedidos = new PedidoDAOImpl();
    ProdutoDAOImpl produtos = new ProdutoDAOImpl();
    ...
    public void conectar() {
        ...
        IDatabase IDatabase = factory.createDatabase();
        IDatabase.connect();
    }
